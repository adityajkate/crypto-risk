...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  float strength = rays1.r * 0.5 + rays2.r * 0.4;
  ...
  vec3 rayCol = raysColor;
  if (saturation != 1.0) {
    float gray = dot(rayCol, vec3(0.299, 0.587, 0.114));
    rayCol = mix(vec3(gray), rayCol, saturation);
  }

  fragColor = vec4(mix(vec3(1.0), rayCol, strength), 1.0);
}
